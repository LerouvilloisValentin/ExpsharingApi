...
const routes : Routes= [
  ...
  {path : 'games/create', component: NewFaceSnapComponent },
  {path : 'games/:id', component: SingleGameComponent },
  {path : 'games', component: GameListComponent },
  {path : 'culinaires/create', component: NewFaceSnapComponent },
  {path : 'culinaires/:id', component: SingleCulinaireComponent },
  {path : 'culinaires', component: CulinaireComponent },
